...
run-commands_parallel.sh: This is the file that is invoked to run the parallelized version of the Nussinov algorithm on the GPU. The path to the sequences.txt needs to be updated in this file

run-commands_serial.sh: This is the file that is invoked to run the parallelized version of the Nussinov algorithm on the GPU. The path to the sequences.txt needs to be updated in this file
